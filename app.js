document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        en: {
            ...
            "hero-desc": "We combine Siteler Ankara's deep-rooted woodcraft tradition with a modern design vision. Rather than single pieces, we bring holistic touches to your living spaces through comprehensive fixed and loose bespoke furniture projects.",
        ...
        tr: {
            ...
            "hero-desc": "Siteler Ankara'nın köklü ahşap işçiliği geleneğini modern tasarım vizyonuyla birleştiriyoruz. Tekil imalat değil, yaşam alanlarınıza bütünsel dokunuşlar katan kapsamlı sabit ve hareketli ahşap mobilya projeleri tasarlıyor ve üretiyoruz.",
