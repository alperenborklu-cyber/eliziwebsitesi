document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        en: {
            ...
            "hero-title": "<span class=\"hero-title-main\">Bespoke Luxury Furniture</span><span class=\"hero-title-sub\">Holistic Touches For Your Living Spaces</span>",
            ...
            "coll-btn-fullscreen": "<svg class=\"icon-svg\"><use href=\"#icon-expand\"></use></svg> View Fullscreen",
            ...
            "blog-exc-3": "Turnkey bespoke furniture solutions, gallery-height wood wall paneling, and fireplace integrations for luxury villas in Cayyolu, Incek, and Umitkoy...",
            ...
            "blog-exc-3-full": "Turnkey bespoke furniture solutions, double-height gallery wood paneling, marble fireplace cabinetry, and master craftsmanship for high-ceiling luxury villas in Cayyolu, Incek, and Umitkoy.",
        ...
        tr: {
            ...
            "hero-title": "<span class=\"hero-title-main\">Özel Tasarım Mobilya</span><span class=\"hero-title-sub\">Yaşam Alanlarınıza Bütünsel Dokunuşlar</span>",
            ...
            "coll-btn-fullscreen": "<svg class=\"icon-svg\"><use href=\"#icon-expand\"></use></svg> Fotoğrafı Büyüt",
    ...
    // --- Preloader Fast & Snappy Dismiss ---
    const preloader = document.getElementById('preloader');
    if (preloader) {
        const alreadyVisited = sessionStorage.getItem('elizi_preloader_seen');
        ...
        if (alreadyVisited) {
            ...
            sessionStorage.setItem('elizi_preloader_seen', '1');
            // Fast, crisp animation for ~450ms on first load, then reveal content immediately
            setTimeout(dismissPreloader, 450);
        }
    }

    // --- Option A: Hero Video Desktop Dynamic Loader ---
    // Mobile (< 768px) keeps the crisp preloaded WebP poster without downloading the 3.12MB MP4
    const initHeroVideo = () => {
        if (window.innerWidth >= 768) {
            const heroVideo = document.querySelector('.hero-video[data-desktop-video]');
            if (heroVideo && !heroVideo.querySelector('source')) {
                const src = heroVideo.getAttribute('data-desktop-video');
